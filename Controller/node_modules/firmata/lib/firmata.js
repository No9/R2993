...
//var SerialPort = require('serialport').SerialPort,
  ...
  //var SerialPort = require('../../../TcpPort');
...
var Board = function(port, callback) {
        ...
        if(typeof port === 'object'){
			console.log("set port to be port");
            this.sp = port;
        } else { 
		...
		console.log("Setting up Board Once");
		board.once('reportversion', function () {
			console.log("Getting Report Version");
            board.versionReceived = true;
...
Board.prototype.reportVersion = function(callback) {
    ...
    this.once('reportversion', callback);
    console.log("Writing REPORT_VERSION");
